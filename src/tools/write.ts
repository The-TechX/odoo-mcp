...
export function registerWriteTools(server: McpServer, writer: WriteService): void {
  server.registerTool('odoo_create', {
    ...
    inputSchema: z.object({ model: modelSchema, values: valuesSchema }),
  ...
  server.registerTool('odoo_write', {
    ...
    inputSchema: z.object({ model: modelSchema, ids: idsSchema, values: valuesSchema }),
  ...
  server.registerTool('odoo_unlink', {
    ...
    inputSchema: z.object({ model: modelSchema, ids: idsSchema }),
